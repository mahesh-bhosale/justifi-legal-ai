  ...
  return (
    <Card>
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 dark:bg-gray-900 dark:text-white transition-colors ${
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 dark:bg-gray-900 dark:text-white transition-colors ${
                errors.readTime ? 'border-red-500' : 'border-gray-300 dark:border-gray-700'
              }`}
              placeholder="5"
            />
            {errors.readTime && (
              <p className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.readTime}</p>
            )}
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 dark:bg-gray-900 dark:text-white transition-colors"
        ...
        {/* Form Actions */}
        <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700 transition-colors">
          <Button
            type="button"
            variant="outline"
            onClick={onCancel}
