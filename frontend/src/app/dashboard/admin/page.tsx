    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <p className="text-gray-600">
          Monitor system performance, manage users, and oversee the legal AI platform.
        </p>
      </div>
      ...
      <Card className="p-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span>New user registration - John Doe (Citizen)</span>
          </div>
          <div className="flex items-center text-sm text-gray-600">
          ...
          <div className="flex items-center text-sm text-gray-600">
            ...
            <span>New lawyer account verified - Sarah Johnson</span>
          </div>
        </div>
      </Card>
    </div>
