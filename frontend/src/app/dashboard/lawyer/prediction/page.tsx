...
export default function LawyerPredictionPage() {
    ...
    <div className="mx-auto flex max-w-6xl flex-col gap-6">
      <header className="space-y-1">
        <h1 className="text-2xl font-semibold text-gray-900">
          Case Outcome Prediction (Lawyer)
        </h1>
        <p className="text-sm text-gray-600">
          Upload case documents to get AI-assisted outcome estimates and
          confidence insights for your legal strategy.
        </p>
      </header>
