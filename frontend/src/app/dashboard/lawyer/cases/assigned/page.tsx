...
export default function LawyerAssignedCasesPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">My Assigned Cases</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{statusCounts.in_progress}</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          <div className="flex items-center">
            <div className="p-2 bg-gray-100 dark:bg-gray-800 rounded-lg border dark:border-gray-700">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{statusCounts.closed}</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      <Card className="p-6">
        {cases.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">No assigned cases found</h3>
