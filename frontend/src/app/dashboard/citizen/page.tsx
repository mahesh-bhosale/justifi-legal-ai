  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          >
            <div className="flex items-center">
              ...
              <span className="font-medium text-gray-900 dark:text-white transition-colors">Start New Case</span>
            </div>
          </button>
          ...
          >
            <div className="flex items-center">
              ...
              <span className="font-medium text-gray-900 dark:text-white transition-colors">AI Legal Assistant</span>
            </div>
          </button>
          ...
          <button 
            ...
            className="w-full text-left p-3 rounded-lg border border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors sm:col-span-2 lg:col-span-1"
          >
            <div className="flex items-center">
              <svg className="w-5 h-5 text-yellow-600 dark:text-yellow-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
              <span className="font-medium text-gray-900 dark:text-white transition-colors">Browse All Lawyers</span>
            </div>
          </button>
        </div>
      </Card>
      ...
      {showLawyerSearch && (
        <Card className="p-6">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Quick Lawyer Search</h2>
            <p className="text-gray-600 dark:text-gray-400">
